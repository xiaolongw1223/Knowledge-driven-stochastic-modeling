...
loss_array, model_cache, acceptance_count = L.mcmc_sampling_single_chain(iter_num=5000, temperature=3)

# Save data
import h5py
num_chain = 1
hf = h5py.File('Sampling_chain_borehole_5k_{}.h5'.format(num_chain), 'w')
